(() => {
          ...
          if ("function" == typeof window.PokiSDK[a])
            if ((null == r ? void 0 : r.resolveFn) || (null == r ? void 0 : r.rejectFn)) {
              ...
              if ((t = window.PokiSDK)[a].apply(t, u).catch((function () {
                ...
                "function" == typeof r.rejectFn && r.rejectFn.apply(r, t), c && setTimeout((function () {
                  e.dequeue()
                }), 0)
              })).then((function () {
                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                "function" == typeof r.resolveFn && r.resolveFn.apply(r, t), c && setTimeout((function () {
                  e.dequeue()
                }), 0)
              })), c) return "break"
  ...
  var a = function () {
    var e = window.pokiSDKVersion || t("ab") || "2728b0cd3fa5ce5b202a04f4dbbca243c15664b6",
      i = "poki-sdk-core".concat(".js");
    n && (i = "poki-sdk-kids-".concat(e, ".js")), o && (i = "poki-sdk-playground-".concat(e, ".js")), r && (i = "poki-sdk-hoist".concat(".js"));
