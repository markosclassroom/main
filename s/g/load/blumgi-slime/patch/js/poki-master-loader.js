...
if (!window.config.unityWebglLoaderUrl) {
    ...
    switch (year) {
    case "2019":
        window.config.unityWebglLoaderUrl = 1 === minor ? "js/unity/UnityLoader.2019.1.js" : "js/unity/UnityLoader.2019.2.js";
        break;
    default:
        window.config.unityWebglLoaderUrl = "js/unity/UnityLoader.js"
    }
}
