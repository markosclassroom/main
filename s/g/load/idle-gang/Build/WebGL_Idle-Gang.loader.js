function createUnityInstance(e, t, n) {
    ...
    function a(e) {
        ...
        if (t && "string" == typeof t.stack && (n += "\n" + t.stack.substring(t.stack.lastIndexOf(n, 0) ? 0 : n.length).replace(/(^\n*|\n*$)/g, "")), n && u.stackTraceRegExp && u.stackTraceRegExp.test(n)) {
            var a = e instanceof ErrorEvent ? e.filename : t && "string" == typeof t.fileName ? t.fileName : t && "string" == typeof t.sourceURL ? t.sourceURL : "",
                i = e instanceof ErrorEvent ? e.lineno : t && "number" == typeof t.lineNumber ? t.lineNumber : t && "number" == typeof t.line ? t.line : 0;
            r(n, a, i)
        }
    }
    ...
    function i(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (var e in u.downloadProgress) {
                ...
                s++, r.lengthComputable ? (a += r.loaded, i += r.total, o++) : r.finished || d++
            }
    ...
    u.SystemInfo = function() {
        ...
        switch (/Windows/.test(u) && (p = /Windows (.*)/.exec(u)[1], u = "Windows"), u) {
            ...
            case "Android":
                ...
                break;
            case "iOS":
                p = /OS (\d+)_(\d+)_?(\d+)?/.exec(a), p = p[1] + "." + p[2] + "." + (0 | p[3])
        }
        return {
            ...
            hasFullscreen: function() {
                var e = document.createElement("canvas");
                return (e.requestFullScreen || e.mozRequestFullScreen || e.msRequestFullscreen || e.webkitRequestFullScreen) && (s.indexOf("Safari") == -1 || o >= 10.1) ? 1 : 0
            }(),
        ...
        return r(e, "", 0), !0
    }, window.addEventListener("error", a), window.addEventListener("unhandledrejection", a), Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), u.XMLHttpRequest = function() {
        function e(e) {
        ...
        function i(t) {
            this.cache = {
                ...
                var t = this.xhr,
                    n = this.cache;
                n.enabled && !n.revalidated && (304 == t.status ? (n.result.revalidated = n.result.accessed, n.revalidated = !0, l.execute(o.name, "put", [n.result]), e("'" + n.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == t.status ? (n.result = a(n.result.url, n.company, n.product, n.result.accessed, t), n.revalidated = !0, l.execute(o.name, "put", [n.result], function(t) {
        ...
        r.prototype.execute = function(e, t, n, r, a) {
            ...
            } else "undefined" == typeof this.database ? this.queue.push(arguments) : "function" == typeof a && a(new Error("indexedDB access denied"))
        };
        var l = new r;
        i.prototype.send = function(t) {
            var r = this.xhr,
                a = this.cache,
                i = arguments;
            return a.enabled = a.enabled && "arraybuffer" == r.responseType && !t, a.enabled ? void l.execute(o.name, "get", [a.result.url], function(t) {
                if (!t || t.version != o.version) return void r.send.apply(r, i);
                if (a.result = t, a.result.accessed = Date.now(), "immutable" == a.control) a.revalidated = !0, l.execute(o.name, "put", [a.result]), r.dispatchEvent(new Event("load")), e("'" + a.result.url + "' served from the indexedDB cache without revalidation");
                else if (n(a.result.url) && (a.result.responseHeaders["Last-Modified"] || a.result.responseHeaders.ETag)) {
                    var s = new XMLHttpRequest;
                    s.open("HEAD", a.result.url), s.onload = function() {
                        a.revalidated = ["Last-Modified", "ETag"].every(function(e) {
                            return !a.result.responseHeaders[e] || a.result.responseHeaders[e] == s.getResponseHeader(e)
                        }), a.revalidated ? (a.result.revalidated = a.result.accessed, l.execute(o.name, "put", [a.result]), r.dispatchEvent(new Event("load")), e("'" + a.result.url + "' successfully revalidated and served from the indexedDB cache")) : r.send.apply(r, i)
                    }, s.send()
                ...
                var t = {
                    "inflate.js": function(e, t, n) {
                        ...
                        r.prototype.push = function(e, t) {
                            ...
                            r = t === ~~t ? t : t === !0 ? l.Z_FINISH : l.Z_NO_FLUSH, "string" == typeof e ? f.input = d.binstring2buf(e) : "[object ArrayBuffer]" === h.call(e) ? f.input = new Uint8Array(e) : f.input = e, f.next_in = 0, f.avail_in = f.input.length;
                            do {
                                if (0 === f.avail_out && (f.output = new o.Buf8(p), f.next_out = 0, f.avail_out = p), n = s.inflate(f, l.Z_NO_FLUSH), n === l.Z_NEED_DICT && b && (c = "string" == typeof b ? d.string2buf(b) : "[object ArrayBuffer]" === h.call(b) ? new Uint8Array(b) : b, n = s.inflateSetDictionary(this.strm, c)), n === l.Z_BUF_ERROR && m === !0 && (n = l.Z_OK, m = !1), n !== l.Z_STREAM_END && n !== l.Z_OK) return this.onEnd(n), this.ended = !0, !1;
                                f.next_out && (0 !== f.avail_out && n !== l.Z_STREAM_END && (0 !== f.avail_in || r !== l.Z_FINISH && r !== l.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = d.utf8border(f.output, f.next_out), i = f.next_out - a, u = d.buf2string(f.output, a), f.next_out = i, f.avail_out = p - i, i && o.arraySet(f.output, f.output, a, i, 0), this.onData(u)) : this.onData(o.shrinkBuf(f.output, f.next_out)))), 0 === f.avail_in && 0 === f.avail_out && (m = !0)
                    ...
                    "utils/strings.js": function(e, t, n) {
                        ...
                        function r(e, t) {
                            if (t < 65537 && (e.subarray && s || !e.subarray && i)) return String.fromCharCode.apply(null, a.shrinkBuf(e, t));
                        ...
                        for (var o = new a.Buf8(256), d = 0; d < 256; d++) o[d] = d >= 252 ? 6 : d >= 248 ? 5 : d >= 240 ? 4 : d >= 224 ? 3 : d >= 192 ? 2 : 1;
                        o[254] = o[254] = 1, n.string2buf = function(e) {
                            var t, n, r, i, s, o = e.length,
                                d = 0;
                            for (i = 0; i < o; i++) n = e.charCodeAt(i), 55296 === (64512 & n) && i + 1 < o && (r = e.charCodeAt(i + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), i++)), d += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4;
                            for (t = new a.Buf8(d), s = 0, i = 0; s < d; i++) n = e.charCodeAt(i), 55296 === (64512 & n) && i + 1 < o && (r = e.charCodeAt(i + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), i++)), n < 128 ? t[s++] = n : n < 2048 ? (t[s++] = 192 | n >>> 6, t[s++] = 128 | 63 & n) : n < 65536 ? (t[s++] = 224 | n >>> 12, t[s++] = 128 | n >>> 6 & 63, t[s++] = 128 | 63 & n) : (t[s++] = 240 | n >>> 18, t[s++] = 128 | n >>> 12 & 63, t[s++] = 128 | n >>> 6 & 63, t[s++] = 128 | 63 & n);
                            return t
                            ...
                            var n, a, i, s, d = t || e.length,
                                l = new Array(2 * d);
                            for (a = 0, n = 0; n < d;)
                                if (i = e[n++], i < 128) l[a++] = i;
                                else if (s = o[i], s > 4) l[a++] = 65533, n += s - 1;
                            else {
                                for (i &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && n < d;) i = i << 6 | 63 & e[n++], s--;
                                s > 1 ? l[a++] = 65533 : i < 65536 ? l[a++] = i : (i -= 65536, l[a++] = 55296 | i >> 10 & 1023, l[a++] = 56320 | 1023 & i)
                            }
                            return r(l, a)
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        function i(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = M, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new g.Buf32(be), t.distcode = t.distdyn = new g.Buf32(me), t.sane = 1, t.back = -1, L) : N
                        }

                        function s(e) {
                            var t;
                            return e && e.state ? (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, i(e)) : N
                        }

                        function o(e, t) {
                            var n, r;
                            return e && e.state ? (r = e.state, t < 0 ? (n = 0, t = -t) : (n = (t >> 4) + 1, t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? N : (null !== r.window && r.wbits !== t && (r.window = null), r.wrap = n, r.wbits = t, s(e))) : N
                        }

                        function d(e, t) {
                            var n, r;
                            return e ? (r = new a, e.state = r, r.window = null, n = o(e, t), n !== L && (e.state = null), n) : N
                        }
                        ...
                        function u(e) {
                            if (ve) {
                                var t;
                                for (m = new g.Buf32(512), w = new g.Buf32(32), t = 0; t < 144;) e.lens[t++] = 8;
                                for (; t < 256;) e.lens[t++] = 9;
                                for (; t < 280;) e.lens[t++] = 7;
                                for (; t < 288;) e.lens[t++] = 8;
                                for (x(E, e.lens, 0, 288, m, 0, e.work, {
                                        bits: 9
                                    }), t = 0; t < 32;) e.lens[t++] = 5;
                                x(S, e.lens, 0, 32, w, 0, e.work, {
                                    bits: 5
                                }), ve = !1
                            }
                        ...
                        function c(e, t, n, r) {
                            var a, i = e.state;
                            return null === i.window && (i.wsize = 1 << i.wbits, i.wnext = 0, i.whave = 0, i.window = new g.Buf8(i.wsize)), r >= i.wsize ? (g.arraySet(i.window, t, n - i.wsize, i.wsize, 0), i.wnext = 0, i.whave = i.wsize) : (a = i.wsize - i.wnext, a > r && (a = r), g.arraySet(i.window, t, n - r, a, i.wnext), r -= a, r ? (g.arraySet(i.window, t, n - r, r, 0), i.wnext = r, i.whave = i.wsize) : (i.wnext += a, i.wnext === i.wsize && (i.wnext = 0), i.whave < i.wsize && (i.whave += a))), 0
                        }

                        function f(e, t) {
                            var n, a, i, s, o, d, l, f, h, p, b, m, w, be, me, we, ge, ve, ye, ke, xe, _e, Ee, Se, Oe = 0,
                                Ce = new g.Buf8(4),
                                Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return N;
                            n = e.state, n.mode === K && (n.mode = V), o = e.next_out, i = e.output, l = e.avail_out, s = e.next_in, a = e.input, d = e.avail_in, f = n.hold, h = n.bits, p = d, b = l, _e = L;
                            e: for (;;) switch (n.mode) {
                                case M:
                                    if (0 === n.wrap) {
                                        n.mode = V;
                                    ...
                                    if (2 & n.wrap && 35615 === f) {
                                        n.check = 0, Ce[0] = 255 & f, Ce[1] = f >>> 8 & 255, n.check = y(n.check, Ce, 2, 0), f = 0, h = 0, n.mode = H;
                                        break
                                    }
                                ...
                                case H:
                                    ...
                                    n.head && (n.head.text = f >> 8 & 1), 512 & n.flags && (Ce[0] = 255 & f, Ce[1] = f >>> 8 & 255, n.check = y(n.check, Ce, 2, 0)), f = 0, h = 0, n.mode = D;
                                case D:
                                    for (; h < 32;) {
                                        if (0 === d) break e;
                                        d--, f += a[s++] << h, h += 8
                                    }
                                    n.head && (n.head.time = f), 512 & n.flags && (Ce[0] = 255 & f, Ce[1] = f >>> 8 & 255, Ce[2] = f >>> 16 & 255, Ce[3] = f >>> 24 & 255, n.check = y(n.check, Ce, 4, 0)), f = 0, h = 0, n.mode = Z;
                                case Z:
                                    for (; h < 16;) {
                                        if (0 === d) break e;
                                        d--, f += a[s++] << h, h += 8
                                    }
                                    n.head && (n.head.xflags = 255 & f, n.head.os = f >> 8), 512 & n.flags && (Ce[0] = 255 & f, Ce[1] = f >>> 8 & 255, n.check = y(n.check, Ce, 2, 0)), f = 0, h = 0, n.mode = z;
                                case z:
                                    if (1024 & n.flags) {
                                        for (; h < 16;) {
                                            if (0 === d) break e;
                                        ...
                                        n.length = f, n.head && (n.head.extra_len = f), 512 & n.flags && (Ce[0] = 255 & f, Ce[1] = f >>> 8 & 255, n.check = y(n.check, Ce, 2, 0)), f = 0, h = 0
                                    } else n.head && (n.head.extra = null);
                                    n.mode = F;
                                case F:
                                    if (1024 & n.flags && (m = n.length, m > d && (m = d), m && (n.head && (xe = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), g.arraySet(n.head.extra, a, s, m, xe)), 512 & n.flags && (n.check = y(n.check, a, m, s)), d -= m, s += m, n.length -= m), n.length)) break e;
                                    n.length = 0, n.mode = j;
                                case j:
                                    if (2048 & n.flags) {
                                        if (0 === d) break e;
                                        m = 0;
                                        do xe = a[s + m++], n.head && xe && n.length < 65536 && (n.head.name += String.fromCharCode(xe)); while (xe && m < d);
                                        if (512 & n.flags && (n.check = y(n.check, a, m, s)), d -= m, s += m, xe) break e
                                ...
                                case P:
                                    if (4096 & n.flags) {
                                        if (0 === d) break e;
                                        m = 0;
                                        do xe = a[s + m++], n.head && xe && n.length < 65536 && (n.head.comment += String.fromCharCode(xe)); while (xe && m < d);
                                        if (512 & n.flags && (n.check = y(n.check, a, m, s)), d -= m, s += m, xe) break e
                                ...
                                case X:
                                    if (0 === n.havedict) return e.next_out = o, e.avail_out = l, e.next_in = s, e.avail_in = d, n.hold = f, n.bits = h, B;
                                ...
                                case Y:
                                    ...
                                    if (n.length = 65535 & f, f = 0, h = 0, n.mode = Q, t === R) break e;
                                case Q:
                                    n.mode = J;
                                case J:
                                    if (m = n.length) {
                                        if (m > d && (m = d), m > l && (m = l), 0 === m) break e;
                                        g.arraySet(i, a, s, m, o), d -= m, s += m, l -= m, o += m, n.length -= m;
                                        break
                                    }
                                    n.mode = K;
                                    break;
                                ...
                                case ee:
                                    ...
                                    if (n.lencode = n.lendyn, n.lenbits = 7, Ee = {
                                            bits: n.lenbits
                                        }, _e = x(_, n.lens, 0, 19, n.lencode, 0, n.work, Ee), n.lenbits = Ee.bits, _e) {
                                ...
                                case te:
                                    for (; n.have < n.nlen + n.ndist;) {
                                        for (; Oe = n.lencode[f & (1 << n.lenbits) - 1], me = Oe >>> 24, we = Oe >>> 16 & 255, ge = 65535 & Oe, !(me <= h);) {
                                            if (0 === d) break e;
                                            d--, f += a[s++] << h, h += 8
                                        }
                                        if (ge < 16) f >>>= me, h -= me, n.lens[n.have++] = ge;
                                        else {
                                            if (16 === ge) {
                                                for (Se = me + 2; h < Se;) {
                                                    if (0 === d) break e;
                                                ...
                                                xe = n.lens[n.have - 1], m = 3 + (3 & f), f >>>= 2, h -= 2
                                            } else if (17 === ge) {
                                                for (Se = me + 3; h < Se;) {
                                                    if (0 === d) break e;
                                                    d--, f += a[s++] << h, h += 8
                                                }
                                                f >>>= me, h -= me, xe = 0, m = 3 + (7 & f), f >>>= 3, h -= 3
                                            } else {
                                                for (Se = me + 7; h < Se;) {
                                                    if (0 === d) break e;
                                                    d--, f += a[s++] << h, h += 8
                                                }
                                                f >>>= me, h -= me, xe = 0, m = 11 + (127 & f), f >>>= 7, h -= 7
                                            }
                                    ...
                                    if (n.lenbits = 9, Ee = {
                                            bits: n.lenbits
                                        }, _e = x(E, n.lens, 0, n.nlen, n.lencode, 0, n.work, Ee), n.lenbits = Ee.bits, _e) {
                                        e.msg = "invalid literal/lengths set", n.mode = fe;
                                        break
                                    }
                                    if (n.distbits = 6, n.distcode = n.distdyn, Ee = {
                                            bits: n.distbits
                                        }, _e = x(S, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Ee), n.distbits = Ee.bits, _e) {
                                ...
                                case re:
                                    if (d >= 6 && l >= 258) {
                                        e.next_out = o, e.avail_out = l, e.next_in = s, e.avail_in = d, n.hold = f, n.bits = h, k(e, b), o = e.next_out, i = e.output, l = e.avail_out, s = e.next_in, a = e.input, d = e.avail_in, f = n.hold, h = n.bits, n.mode === K && (n.back = -1);
                                        break
                                    }
                                    for (n.back = 0; Oe = n.lencode[f & (1 << n.lenbits) - 1], me = Oe >>> 24, we = Oe >>> 16 & 255, ge = 65535 & Oe, !(me <= h);) {
                                        if (0 === d) break e;
                                        d--, f += a[s++] << h, h += 8
                                    }
                                    if (we && 0 === (240 & we)) {
                                        for (ve = me, ye = we, ke = ge; Oe = n.lencode[ke + ((f & (1 << ve + ye) - 1) >> ve)], me = Oe >>> 24, we = Oe >>> 16 & 255, ge = 65535 & Oe, !(ve + me <= h);) {
                                            if (0 === d) break e;
                                            d--, f += a[s++] << h, h += 8
                                        }
                                        f >>>= ve, h -= ve, n.back += ve
                                    }
                                    if (f >>>= me, h -= me, n.back += me, n.length = ge, 0 === we) {
                                        n.mode = de;
                                        break
                                    }
                                    if (32 & we) {
                                ...
                                case ie:
                                    for (; Oe = n.distcode[f & (1 << n.distbits) - 1], me = Oe >>> 24, we = Oe >>> 16 & 255, ge = 65535 & Oe, !(me <= h);) {
                                        if (0 === d) break e;
                                        d--, f += a[s++] << h, h += 8
                                    }
                                    if (0 === (240 & we)) {
                                        for (ve = me, ye = we, ke = ge; Oe = n.distcode[ke + ((f & (1 << ve + ye) - 1) >> ve)], me = Oe >>> 24, we = Oe >>> 16 & 255, ge = 65535 & Oe, !(ve + me <= h);) {
                                            if (0 === d) break e;
                                            d--, f += a[s++] << h, h += 8
                                        }
                                        f >>>= ve, h -= ve, n.back += ve
                                ...
                                case oe:
                                    ...
                                    if (m = b - l, n.offset > m) {
                                        ...
                                        m > n.wnext ? (m -= n.wnext, w = n.wsize - m) : w = n.wnext - m, m > n.length && (m = n.length), be = n.window
                                ...
                                case le:
                                    if (n.wrap) {
                                        ...
                                        if (b -= l, e.total_out += b, n.total += b, b && (e.adler = n.check = n.flags ? y(n.check, i, b, o - b) : v(n.check, i, b, o - b)), b = l, (n.flags ? f : r(f)) !== n.check) {
                            ...
                            return e.next_out = o, e.avail_out = l, e.next_in = s, e.avail_in = d, n.hold = f, n.bits = h, (n.wsize || b !== e.avail_out && n.mode < fe && (n.mode < le || t !== O)) && c(e, e.output, e.next_out, b - e.avail_out) ? (n.mode = he, I) : (p -= e.avail_in, b -= e.avail_out, e.total_in += p, e.total_out += b, n.total += b, n.wrap && b && (e.adler = n.check = n.flags ? y(n.check, i, b, e.next_out - b) : v(n.check, i, b, e.next_out - b)),
                                e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === K ? 128 : 0) + (n.mode === ne || n.mode === Q ? 256 : 0), (0 === p && 0 === b || t === O) && _e === L && (_e = U), _e)
                        }
                        ...
                        function p(e, t) {
                            var n;
                            return e && e.state ? (n = e.state, 0 === (2 & n.wrap) ? N : (n.head = t, t.done = !1, L)) : N
                        }

                        function b(e, t) {
                            var n, r, a, i = t.length;
                            return e && e.state ? (n = e.state, 0 !== n.wrap && n.mode !== X ? N : n.mode === X && (r = 1, r = v(r, t, i, 0), r !== n.check) ? A : (a = c(e, t, i, i)) ? (n.mode = he, I) : (n.havedict = 1, L)) : N
                        }
                        var m, w, g = e("../utils/common"),
                            v = e("./adler32"),
                            y = e("./crc32"),
                            k = e("./inffast"),
                            x = e("./inftrees"),
                            ...
                            ge = we,
                            ve = !0;
                        n.inflateReset = s, n.inflateReset2 = o, n.inflateResetKeep = i, n.inflateInit = l, n.inflateInit2 = d, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = p, n.inflateSetDictionary = b, n.inflateInfo = "pako inflate (from Nodeca project)"
                    },
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, i, s, o, d, l, u, c, f, h, p, b, m, w, g, v, y, k, x, _, E, S, O, C, R;
                            n = e.state, i = e.next_in, C = e.input, s = i + (e.avail_in - 5), o = e.next_out, R = e.output, d = o - (t - e.avail_out), l = o + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, b = n.hold, m = n.bits, w = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, y = (1 << n.distbits) - 1;
                            e: do {
                                m < 15 && (b += C[i++] << m, m += 8, b += C[i++] << m, m += 8), k = w[b & v];
                                t: for (;;) {
                                    if (x = k >>> 24, b >>>= x, m -= x, x = k >>> 16 & 255, 0 === x) R[o++] = 65535 & k;
                                    else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = w[(65535 & k) + (b & (1 << x) - 1)];
                                        ...
                                        _ = 65535 & k, x &= 15, x && (m < x && (b += C[i++] << m, m += 8), _ += b & (1 << x) - 1, b >>>= x, m -= x), m < 15 && (b += C[i++] << m, m += 8, b += C[i++] << m, m += 8), k = g[b & y];
                                        n: for (;;) {
                                            if (x = k >>> 24, b >>>= x, m -= x, x = k >>> 16 & 255, !(16 & x)) {
                                                if (0 === (64 & x)) {
                                                    k = g[(65535 & k) + (b & (1 << x) - 1)];
                                                    continue n
                                                }
                                            ...
                                            if (E = 65535 & k, x &= 15, m < x && (b += C[i++] << m, m += 8, m < x && (b += C[i++] << m, m += 8)), E += b & (1 << x) - 1, E > u) {
                                            ...
                                            if (b >>>= x, m -= x, x = o - d, E > x) {
                                                ...
                                                for (; _ > 2;) R[o++] = O[S++], R[o++] = O[S++], R[o++] = O[S++], _ -= 3;
                                                _ && (R[o++] = O[S++], _ > 1 && (R[o++] = O[S++]))
                                            } else {
                                                S = o - E;
                                                do R[o++] = R[S++], R[o++] = R[S++], R[o++] = R[S++], _ -= 3; while (_ > 2);
                            ...
                            _ = m >> 3, i -= _, m -= _ << 3, b &= (1 << m) - 1, e.next_in = i, e.next_out = o, e.avail_in = i < s ? 5 + (s - i) : 5 - (i - s), e.avail_out = o < l ? 257 + (l - o) : 257 - (o - l), n.hold = b, n.bits = m
                        }
                    },
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, p, b, m, w, g) {
                            var v, y, k, x, _, E, S, O, C, R = g.bits,
                                L = 0,
                                W = 0,
                                B = 0,
                                N = 0,
                            ...
                            if (A > N && (A = N), 0 === N) return b[m++] = 20971520, b[m++] = 20971520, g.bits = 1, 0;
                            for (B = 1; B < N && 0 === z[B]; B++);
                            ...
                            if (e === o ? (D = j = w, E = 19) : e === d ? (D = u, Z -= 257, j = c, P -= 257, E = 256) : (D = f, j = h, E = -1), H = 0, W = 0, L = B, _ = m, I = A, U = 0, k = -1, M = 1 << A, x = M - 1, e === d && M > i || e === l && M > s) return 1;
                            for (;;) {
                                S = L - U, w[W] < E ? (O = 0, C = w[W]) : w[W] > E ? (O = j[P + w[W]], C = D[Z + w[W]]) : (O = 96, C = 0), v = 1 << L - U, y = 1 << I, B = y;
                                do y -= v, b[_ + (H >> U) + y] = S << 24 | O << 16 | C | 0; while (0 !== y);
                                for (v = 1 << L - 1; H & v;) v >>= 1;
                                if (0 !== v ? (H &= v - 1, H += v) : H = 0, W++, 0 === --z[L]) {
                                    if (L === N) break;
                                    L = t[n + w[W]]
                                }
                                if (L > A && (H & x) !== k) {
                                    for (0 === U && (U = A), _ += B, I = L - U, T = 1 << I; I + U < N && (T -= z[I + U], !(T <= 0));) I++, T <<= 1;
                                    if (M += 1 << I, e === d && M > i || e === l && M > s) return 1;
                                    k = H & x, b[k] = A << 24 | I << 16 | _ - m | 0
                                }
                            }
                            return 0 !== H && (b[_ + H] = L - U << 24 | 64 << 16 | 0), g.bits = A, 0
                        }
                    }
                };
