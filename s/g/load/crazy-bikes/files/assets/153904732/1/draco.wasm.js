...
$jscomp.polyfillIsolated = function(k, n, l, p) {
    ...
    null != n && (k ? $jscomp.defineProperty($jscomp.polyfills, h, {
        ...
        writable: !0,
        value: n
    }) : n !== l && (void 0 === $jscomp.propertyToPolyfillSymbol[h] && (l = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ?
        $jscomp.global.Symbol(h) : $jscomp.POLYFILL_PREFIX + l + "$" + h), $jscomp.defineProperty(p, $jscomp.propertyToPolyfillSymbol[h], {
        configurable: !0,
        writable: !0,
        value: n
    })))
...
$jscomp.polyfill("Promise", function(k) {
    ...
    h.all = function(f) {
        var q = $jscomp.makeIterator(f),
            v = q.next();
        return v.done ? l([]) : new h(function(z,
            O) {
            function ba(D) {
                return function(R) {
                    t[D] = R;
...
$jscomp.assign = $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign ? Object.assign : function(k, n) {
    for (var l = 1; l < arguments.length; l++) {
        var p = arguments[l];
        if (p)
            for (var h in p) $jscomp.owns(p, h) && (k[h] = p[h])
    }
    return k
};
...
$jscomp.polyfill("Array.prototype.copyWithin", function(k) {
    ...
    return k ? k : function(l, p, h) {
        ...
        if (l < p)
            for (; p < h;) p in this ? this[l++] = this[p++] : (delete this[l++], p++);
        else
            for (h = Math.min(h, A + p - l), l += h - p; h > p;) --h in this ? this[--l] = this[h] : delete this[--l];
        return this
    }
}, "es6", "es3");
    ...
    return function(n) {
            ...
            for (d = ""; b < c;) {
                ...
                if (g & 128) {
                    ...
                    if (192 == (g & 224)) d += String.fromCharCode((g & 31) << 6 | u);
                        ...
                        var X = e[b++] & 63;
                        g = 224 ==
                            (g & 240) ? (g & 15) << 12 | u << 6 | X : (g & 7) << 18 | u << 12 | X << 6 | e[b++] & 63;
        ...
        function ba() {
            function e() {
                if (!la && (la = !0, a.calledRun = !0, !wa)) {
                    ...
                    if (a.postRun)
                        for ("function" == typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length;) Ba.unshift(a.postRun.shift());
                    z(Ba)
                }
            }
            if (!(0 < aa)) {
                if (a.preRun)
                    for ("function" ==
                        typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;) Ca.unshift(a.preRun.shift());
                z(Ca);
        ...
        var bb = a._emscripten_bind_VoidPtr___destroy___0 = function() {
            ...
            wb = a._emscripten_bind_AttributeOctahedronTransform_InitFromAttribute_1 = function() {
                return (wb = a._emscripten_bind_AttributeOctahedronTransform_InitFromAttribute_1 = a.asm.L).apply(null,
                    arguments)
            },
            ...
            Ja = a._emscripten_bind_PointCloud_PointCloud_0 = function() {
                return (Ja = a._emscripten_bind_PointCloud_PointCloud_0 = a.asm.O).apply(null,
                    arguments)
            },
            ...
            Ib = a._emscripten_bind_Status_ok_0 = function() {
                return (Ib =
                    a._emscripten_bind_Status_ok_0 = a.asm._).apply(null, arguments)
            },
            ...
            Tb = a._emscripten_bind_DracoUInt8Array___destroy___0 =
            function() {
            ...
            kd = a._emscripten_enum_draco_DataType_DT_FLOAT32 = function() {
                return (kd = a._emscripten_enum_draco_DataType_DT_FLOAT32 = a.asm.Jb).apply(null,
                    arguments)
            },
        ...
        Q.prototype.transform_type = Q.prototype.transform_type =
            function() {
                return eb(this.ptr)
            };
        ...
        w.prototype.byte_offset =
            w.prototype.byte_offset = function() {
                return ob(this.ptr)
            };
        ...
        C.prototype.quantization_bits =
            C.prototype.quantization_bits = function() {
                return sb(this.ptr)
            };
        ...
        F.prototype.InitFromAttribute = F.prototype.InitFromAttribute =
            function(b) {
                var c = this.ptr;
                b && "object" === typeof b && (b = b.ptr);
                return !!wb(c, b)
        ...
        y.prototype.GetIntEntry =
            y.prototype.GetIntEntry = function(b, c) {
                var d = this.ptr;
                r.prepare();
                b && "object" === typeof b && (b = b.ptr);
                c = c && "object" === typeof c ? c.ptr : R(c);
        ...
        m.prototype.DecodeArrayToMesh = m.prototype.DecodeArrayToMesh =
            function(b, c, d) {
                var g = this.ptr;
                r.prepare();
                "object" == typeof b && (b = pa(b));
        ...
        m.prototype.GetFaceFromMesh = m.prototype.GetFaceFromMesh = function(b,
            c, d) {
            var g = this.ptr;
            b && "object" === typeof b && (b = b.ptr);
            c && "object" === typeof c && (c = c.ptr);
